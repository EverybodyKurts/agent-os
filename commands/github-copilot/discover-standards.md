...
This GitHub Copilot agent skill helps you identify and document patterns, conventions, and tribal knowledge from your codebase that should be captured as standards.
...
- **Ask questions interactively** — Present options the user can confirm, choose between, or correct
...
2. For each new file without an index entry, ask user:
...
When processing large codebases or complex analysis, consider using GitHub Copilot sub-agents to:
